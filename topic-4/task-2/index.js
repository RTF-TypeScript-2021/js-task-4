...
Hamburger.SIZE_SMALL = 'SIZE_SMALL'; //price 50 kal 20
Hamburger.SIZE_LARGE = 'SIZE_LARGE'; //price 100 kal 40
...
Hamburger.prototype.addTopping = function (topping) {
    ...
    if (this.topping.indexOf(topping) !== -1) {
        throw new Error("Данная добавка уже присутствует в гамбургере");
    }
...
Hamburger.prototype.removeTopping = function (topping) {
    ...
    if (this.topping.indexOf(topping) === -1) {
        throw new Error("Данная добавка отсутвует в гамбургере")
    }
